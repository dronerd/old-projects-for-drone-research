#ifndef UUID138451094980160
#define UUID138451094980160


    #ifndef UUID138451094994896
#define UUID138451094994896
 ...
 * ---------
 *  - Resize(from=(320, 240), to=(40, 30), pixformat=gray)
 *  > HOG(block_size=8, bins=9, cell_size=3)
 */
class HogPipeline {
    public:
...
uint16_t latencyInMillis() {
    ...
    for (uint16_t y = 0; y < 30; y++) {
        const size_t sourceOffset = round(y * dy) * 320;
